    ...
    >
      <div className="bg-white rounded-2xl p-10 w-full max-w-md shadow-2xl">
        ...
        <button
          ...
          disabled={signingIn}
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all font-bold text-slate-700 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {signingIn ? (
